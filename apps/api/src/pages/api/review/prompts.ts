...
export const systemInstructions = [
  ...
  "2. Describe why the violation was triggered in `errorDescription`.",
  "3. Suggest a fix, `suggestedFix`, for the violated lines. If the violation spans multiple lines, insert a newline character '\\n' between each line. If no fix is available, you can return 'undefined'.",
