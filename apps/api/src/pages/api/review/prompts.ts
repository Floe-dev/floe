...
export const systemInstructions = [
  ...
  "3. Suggest a fix, `suggestedFix`, for the violated lines. The fix must be able to replace the violated lines, not just a single word. If the violation spans multiple lines, insert a newline character '\\n' between each line. If no fix is available, you can return 'undefined'.",
