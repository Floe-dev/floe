...
const DocPage = ({ doc }: { doc: RenderedPostContent }) => (
  <PostPrimitive.Root post={doc}>
    <div className="relative m-auto mb-4 prose no-underline border-b last:pb-0 last:border-0 border-zinc-700 dark:prose-invert">
      {/* TITLE */}
      <PostPrimitive.Title className="mt-0 text-4xl" />

      {/* CONTENT */}
      <PostPrimitive.Content className="font-normal" />
    </div>
  </PostPrimitive.Root>
);
